...
def get_sources(category):
    ...
    '''
    get_sources_url = base_url.format(base_url,'a915569b8a814812a450a7fc60c4c2cd')

    with urllib.request.urlopen(base_url + 'a915569b8a814812a450a7fc60c4c2cd') as url:
...
def get_articles(id):
    ...
    '''
    get_articles_url = base_article_url.format(id,'a915569b8a814812a450a7fc60c4c2cd')
